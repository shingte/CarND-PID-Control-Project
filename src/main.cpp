...
int main()
{
  ...
  // Only proportional.
  // Over shooting - reducing the rise time and will reduce but 
  // never eliminate the steady-state error. 
  // Video 1 in README
  // pid.Init(1, 0.0, 0.0);

  // Only integral.
  // Systematic error accumulation - eliminating the steady-state error, 
  ...
  // Only differential.
  // Video 3 in README
  // The effect of increasing the stability of the system, 
